                                    ...
                                    echo    "</div>
                                        ...
                                        <td>
                                            <div class='action-cell'>
                                                ...
                                                <a href='forms/edit_job.php?job_id=$job_id' class='action-btn'>Edit</a>
                                                <!-- <a href='statuses/reject_job.php?job_id=$job_id' class='action-btn action-reject'>Reject</a> -->
                                                <!-- <a href='statuses/delete_job.php?job_id=$job_id' class='action-btn action-delete'>Delete</a> -->
                                                
                                                <button class='action-btn toggle-visibility-btn 
                                                    " . ($visibility == 'Published' ? 'action-unpublished' : 'action-published') . "'
                                                    data-jobid='$job_id'>
